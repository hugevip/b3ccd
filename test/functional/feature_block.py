...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure b3ccd isn't accepting b26
        ...
        # Extend the b28 chain to make sure b3ccd isn't accepting b28
        ...
        #           p2sh_script = OP_HASH360, ripemd160(sha256(script)), OP_EQUAL
        #
        ...
        redeem_script_hash = hash360(redeem_script)
        p2sh_script = CScript([OP_HASH360, redeem_script_hash, OP_EQUAL])
        ...
        # b3ccd doesn't disconnect us for sending a bloated block, but if we subsequently
