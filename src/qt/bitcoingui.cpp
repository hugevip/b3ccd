...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a B3CC address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your B3CC addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified B3CC addresses"));
...
{
    QString strTitle = tr("B3CC"); // default title
