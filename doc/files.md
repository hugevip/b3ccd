...
* bitcoin.conf: contains configuration settings for b3ccd or b3cc-qt
* b3ccd.pid: stores the process id of b3ccd while running
...
* debug.log: contains debug information and general logging generated by b3ccd or b3cc-qt
